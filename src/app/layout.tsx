...
export const metadata: Metadata = {
  title: "Blush Nail Studio - Premium Nail Care Services",
  description: "Experience luxury nail care with professional manicures, pedicures, and nail art. Book your appointment at Blush Nail Studio today.",
  keywords: "nail salon, manicure, pedicure, nail art, gel nails, nail care, beauty salon",
  metadataBase: new URL("https://blushnailstudio.com"),
  alternates: {
    canonical: "https://blushnailstudio.com"
  },
  openGraph: {
    title: "Blush Nail Studio - Premium Nail Care Services",
    description: "Experience luxury nail care with professional manicures, pedicures, and nail art. Book your appointment today.",
    siteName: "Blush Nail Studio",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763131583465-vhor18id.jpg",
  ...
  twitter: {
    ...
    title: "Blush Nail Studio - Premium Nail Care Services",
    description: "Experience luxury nail care with professional manicures, pedicures, and nail art.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763131583465-vhor18id.jpg"]
  },
  robots: {
    index: true,
    follow: true
